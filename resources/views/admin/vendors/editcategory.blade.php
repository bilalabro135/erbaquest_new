@extends('layouts.admin.app', ['title' => 'Edit Vendor Category'])
...
@section('content')
    <div class="container">
        ...
        <form action="{{route('admin.vendor.category.update.id',$category->id)}}" method="POST" autocomplete="off">
            @csrf
            <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="site_name">{{ __('Edit Name*') }}</label>
                                <input type="text"  id="name" class="form-control  @error('name') is-invalid @enderror" name="name" placeholder="Enter Full Name*" required="" value="{{ isset($category->name) ? $category->name : (old('name'))}}">        
                                @error('name')

            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <textarea type="text"  class="form-control @error('descreption') is-invalid @enderror" id="descreption" placeholder="descreption" name="descreption">{{$vendor->description }}</textarea>
                            @error('descreption')
                                <div class="text-danger">
                                    {{$message}}                                            
                                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card shadow profile_image mb-4">
                        ...
                        <div class="card-body">
                            <input type="hidden" id="profile_pic" name="picture" value="{{$vendor->picture}}">

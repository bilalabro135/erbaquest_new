@extends('layouts.admin.app', ['title' => 'Edit Podcast Category'])
...
@section('content')
    <div class="container">
        ...
        @endif
         ...
         <h1 class="h3 mb-4 text-gray-800">Edit Podcast Category</h1>
         <div class="row">
         	@can('updateCategories')
		    	<div class="col-md-8">
		    		<form class="user" action="{{route('podcast.categories.update', ['category' => request('category')])}}" method="POST">
		    			@csrf

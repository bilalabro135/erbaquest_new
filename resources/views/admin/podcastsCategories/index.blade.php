@extends('layouts.admin.app', ['title' => 'All Podcast Categories'])
...
@section('content')
    <div class="container">
        ...
        @endif
         ...
         <h1 class="h3 mb-4 text-gray-800">All Podcast Categories</h1>
         <div class="row">
	    	<div class="col-md-4">
	    		<form class="user" action="{{route('podcast.categories.store')}}" method="POST">
	    			@csrf
	    		<div class="card shadow">
	    			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
	                	<h6 class="m-0 font-weight-bold text-primary">Add Podcast Category</h6>		              
		            </div>
		            <div class="card-body">
	...
	<script type="text/javascript">
		$(document).ready( function () {
		  ...
		  $('#dataTable').DataTable({
		         ...
		         serverSide: true,
		         ajax: {
		          url: "{{ route('podcast.categories.get') }}",
		          type: 'GET',
		         },
		         columns: [

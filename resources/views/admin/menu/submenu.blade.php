    ...
    <div class="item-settings d-none">
        ...
        <p>
            <label for="">Navigation Url<br>
                <input type="text" class="form-control" name="navigation_url" value="{{get_url($menu_child->link)}}">
            </label>
        </p>
        <p>
        ...
        <p>
            <label for="">Only Visible for Authenticated Users
                <input {{($menu_child->visible_for_auth == 1) ? 'checked="checked"' : ''}} type="checkbox" name="visible_for_auth" value="1">
            </label>
        </p>
        <p>
            <label for="">Only Visible for Guest Users
                <input {{($menu_child->visible_for_guest == 1) ? 'checked="checked"' : ''}} type="checkbox" name="visible_for_guest" value="1">
            </label>
        </p>
        <p>
